...
![Title "Harness engineering for coding agent users". Overview of guides and feedback sensors that feed forward into a coding agent, with a human who steers both.](https://martinfowler.com/articles/harness-engineering/harness-overview.png)
...
|---|---|---|
| Coding conventions | feedforward | AGENTS.md, Skills |
| Instructions how to bootstrap a new project | feedforward | Skill with instructions and a bootstrap script |
| Code mods | feedforward | A tool with access to OpenRewrite recipes |
| Structural tests | feedback | A pre-commit (or coding agent) hook running ArchUnit tests that check for violations of module boundaries |
| Instructions how to review | feedback | Skills |
...
![Examples of feedforward and feedback in a change's lifecycle.](https://martinfowler.com/articles/harness-engineering/harness-change-lifecycle-examples.png)
...
![Simplified overview of a harness showing guides and sensors in horizontal, and then the regulation dimensions maintainability, architecture fitness, and behaviour, in vertical.](https://martinfowler.com/articles/harness-engineering/harness-types.png)
...
![A stack of examples of topologies (Data dashboard in Node, CRUD business service on JVM, event processor in Golang).](https://martinfowler.com/articles/harness-engineering/harness-templates.png)
